...
const String WIN_TITLE = 'Jogador [SYMBOL] venceu!';
const String DIALOG_MESSAGE = 'Pressione o botão RESET para começar um novo jogo!!';
const String SINGLE_PLAYER_MODE_LABEL = 'Único Jogador';
